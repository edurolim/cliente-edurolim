# PRI-101 - Status do carrossel

- Base editorial: `deliverables/pri-100-chatgpt-ads-feedmaker.md`
- Insumo de pesquisa: `08-pesquisa/pesquisa-diaria-ia-2026-07-21-pri-99.md`
- Padrao visual aplicado: `carrossel-edurolim-2026-julho`
- Estrutura: 7 slides adaptados ao volume real de 10 textos
- Arquivos do pacote:
  - `carrossel.html`
  - `image-prompts.md`
  - `render_pngs.js`
...
- Carrossel visual produzido para o issue `PRI-101` a partir da pauta principal do PRI-99 sobre ChatGPT Ads.
- Linha editorial inferida: NOTICIAS.
- Topico inferido: explicar o que uma mudanca no setor significa na pratica.
